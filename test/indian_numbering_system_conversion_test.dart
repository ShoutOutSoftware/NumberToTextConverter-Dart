...
void main() {
  ...
  test('indian numbering system number conversion', () {
    ...
    expect(converter.convert(100013), 'one lakh thirteen');
    ...
    expect(converter.convert(1000000000), 'one hundred crore');
    expect(converter.convert(1000000001), 'one hundred crore one');
